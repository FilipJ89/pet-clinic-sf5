...
import com.example.petclinicsf5.model.security.LoginSuccess;
import com.example.petclinicsf5.model.security.User;
import com.example.petclinicsf5.repositories.security.LoginSuccessRepository;
    ...
    public void listen(AuthenticationSuccessEvent event){
        ...
        if (event.getSource() instanceof UsernamePasswordAuthenticationToken) {
            ...
            if(token.getDetails() instanceof WebAuthenticationDetails){
                ...
                log.debug("User source IP: " + details.getRemoteAddress());
